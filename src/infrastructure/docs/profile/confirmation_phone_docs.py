        ...
        "200": {
            ...
            "content": {
                "application/json": {
                    "example": {
                            "isSuccess": True,
                            "message": "Отправлен код подтверждения на указанный номер телефона.",
                            "data": {}
                        }
                    }
                }
        ...
        "400": {
            ...
            "content": {
                ...
                "application_2/json": {
                    "example": {
                            "isSuccess": False,
                            "message": "Не удалось отправить код подтверждения на указанный номер телефона, повторите попытку.",
                            "data": {}
                        }
                    }
                }
